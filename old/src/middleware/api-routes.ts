...
import { router as EnvelopeSettingsController } from "../controllers/envelopes";
import { router as EnvelopeAllocationsSettingsController } from "../controllers/envelope-allocations";
import { router as EnvelopeTransfersSettingsController } from "../controllers/envelope-transfers";
...
function setupApiRoutes(app: Express): void {
  ...
  app.use("/api/envelopes", EnvelopeSettingsController);
  app.use("/api/envelope-allocations", EnvelopeAllocationsSettingsController);
  app.use("/api/envelope-transfers", EnvelopeTransfersSettingsController);
