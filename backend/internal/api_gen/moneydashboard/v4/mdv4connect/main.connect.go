...
// period.
const (
	// MDServiceGetAllCurrenciesProcedure is the fully-qualified name of the MDService's
	// GetAllCurrencies RPC.
	MDServiceGetAllCurrenciesProcedure = "/moneydashboard.v4.MDService/GetAllCurrencies"
...
func NewMDServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MDServiceClient {
	...
	mDServiceMethods := v4.File_moneydashboard_v4_main_proto.Services().ByName("MDService").Methods()
	return &mDServiceClient{
		getAllCurrencies: connect.NewClient[v4.GetAllCurrenciesRequest, v4.GetAllCurrenciesResponse](
			httpClient,
			baseURL+MDServiceGetAllCurrenciesProcedure,
			connect.WithSchema(mDServiceMethods.ByName("GetAllCurrencies")),
...
// GetAllCurrencies calls moneydashboard.v4.MDService.GetAllCurrencies.
func (c *mDServiceClient) GetAllCurrencies(ctx context.Context, req *connect.Request[v4.GetAllCurrenciesRequest]) (*connect.Response[v4.GetAllCurrenciesResponse], error) {
...
func NewMDServiceHandler(svc MDServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	mDServiceMethods := v4.File_moneydashboard_v4_main_proto.Services().ByName("MDService").Methods()
	mDServiceGetAllCurrenciesHandler := connect.NewUnaryHandler(
		MDServiceGetAllCurrenciesProcedure,
	...
	return "/moneydashboard.v4.MDService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case MDServiceGetAllCurrenciesProcedure:
			mDServiceGetAllCurrenciesHandler.ServeHTTP(w, r)
...
func (UnimplementedMDServiceHandler) GetAllCurrencies(context.Context, *connect.Request[v4.GetAllCurrenciesRequest]) (*connect.Response[v4.GetAllCurrenciesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("moneydashboard.v4.MDService.GetAllCurrencies is not implemented"))
}
