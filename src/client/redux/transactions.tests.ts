...
import { DEFAULT_TRANSACTION } from "../../models/ITransaction";
import {
  setDateMode,
  setEditorBusy,
  setPayeeList,
  ...
  describe("transactionsReducer()", () => {
    ...
    describe(TransactionActions.SET_TRANSACTION_TO_EDIT, () => {
      it("should set the transaction to edit", () => {
        ...
        transactionsReducer(undefined, setTransactionToEdit(DEFAULT_TRANSACTION)).transactionToEdit.should.equal(
          DEFAULT_TRANSACTION,
        );
      });
    });
