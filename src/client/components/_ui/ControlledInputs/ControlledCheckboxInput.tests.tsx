...
describe(__filename, () => {
  ...
  it("should render a text label", () => {
    mountWrapper = mount(
      <ControlledCheckboxInput id={"test-id"} label={"Test Label"} checked={true} onCheckedChange={voidListener} />,
    );
  ...
  it("should call the change listener when the value changes", () => {
    const spy = sinon.spy();
    mountWrapper = mount(
      <ControlledCheckboxInput id={"test-id"} label={"Test Label"} checked={true} onCheckedChange={spy} />,
    );
