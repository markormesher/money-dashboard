...
describe(__filename, () => {
	...
	it("should pass core props to the input", () => {
		...
		mountWrapper.find("input").props().placeholder.should.equal("test-placeholder");
		...
		mountWrapper.find("input").props().placeholder.should.equal("test-placeholder2");
	...
	it("should call the change listener when the value changes", () => {
		...
		mountWrapper.find("input").simulate("change", { target: { value: "new-val" } });
