...
describe(__filename, () => {
  ...
  it("should render a header for each column", () => {
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1, col2]} />
      </table>,
    );
  ...
  it("should render an 'small to big' icon for ASC sorted", () => {
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} sortedColumns={[{ column: col1, dir: "ASC" }]} />
      </table>,
    );
    mountWrapper
  ...
  it("should render a 'big to small' icon for desc sorted", () => {
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} sortedColumns={[{ column: col1, dir: "DESC" }]} />
      </table>,
    );
    mountWrapper
      .find(FontAwesomeIcon)
  ...
  it("should render a 'swap' icon for non-sorted", () => {
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} />
      </table>,
    );
    mountWrapper
      .find(FontAwesomeIcon)
  ...
  it("should call the listener with a different sort order when a sortable column is clicked", () => {
    ...
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} sortedColumns={originalSortOrder} onSortOrderUpdate={spy} />
      </table>,
    );
  ...
  it("should not call the listener when a non-sortable column is clicked", () => {
    ...
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col3]} sortedColumns={[]} onSortOrderUpdate={spy} />
      </table>,
    );
    mountWrapper.find("th").simulate("click");
  ...
  it("should determine the correct default sort order with a single default", () => {
    const col1WithSort: IColumn = { ...col1, defaultSortDirection: "ASC" };
    const spy = sinon.spy();
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1WithSort, col2, col3]} onSortOrderUpdate={spy} />
      </table>,
    );
    spy.lastCall.args[0].should.deep.equal([{ column: col1WithSort, dir: "ASC" }]);
  });

  it("should determine the correct default sort order with multiple defaults", () => {
    ...
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1WithSort, col2WithSort, col3]} onSortOrderUpdate={spy} />
      </table>,
    );
  ...
  it("should determine the correct default sort order with multiple defaults with no order", () => {
    const col1WithSort: IColumn = { ...col1, defaultSortDirection: "ASC" };
    const col2WithSort: IColumn = { ...col2, defaultSortDirection: "DESC" };
    const spy = sinon.spy();
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1WithSort, col2WithSort, col3]} onSortOrderUpdate={spy} />
  ...
  it("should determine the correct next sort order for a single column (none -> asc)", () => {
    ...
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} sortedColumns={[]} onSortOrderUpdate={spy} />
      </table>,
    );
    mountWrapper.find("th").simulate("click");
  ...
  it("should determine the correct next sort order for a single column (asc -> desc)", () => {
    ...
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} sortedColumns={[{ column: col1, dir: "ASC" }]} onSortOrderUpdate={spy} />
      </table>,
    );
    mountWrapper.find("th").simulate("click");
  ...
  it("should not fail when the sort order changes and there is no listener", () => {
    mountWrapper = mount(
      <table>
        <DataTableInnerHeader columns={[col1]} />
      </table>,
