// TODO: some of these tests hang forever because... reasons
...
//     mountWrapper = mount(<DataTable<IMockData> columns={mockColumns} rowRenderer={mockRowRenderer} pageSize={20} />);
...
//     const mockProvider = new MockDataProvider();
//     mountWrapper = mount(
//       <DataTable<IMockData> columns={mockColumns} rowRenderer={mockRowRenderer} dataProvider={mockProvider} />,
//     );
...
//     const callCountBefore = mockProvider.callCount;
//     mountWrapper
//       .find(DataTableInnerHeader)
//       .props()
//       .onSortOrderUpdate([{ column: mockCol1, dir: "ASC" }]);
//     mockProvider.callCount.should.be.greaterThan(callCountBefore);
//   });
