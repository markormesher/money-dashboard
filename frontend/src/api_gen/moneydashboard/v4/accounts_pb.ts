...
import type { AccountGroup } from "./account_groups_pb.js";
import { file_moneydashboard_v4_account_groups } from "./account_groups_pb.js";
...
export const file_moneydashboard_v4_accounts: GenFile = /*@__PURE__*/
  fileDesc("", [file_moneydashboard_v4_account_groups]);
...
export type Account = Message<"moneydashboard.v4.Account"> & {
  ...
  /**
   * @generated from field: bool exclude_from_reports = 7;
   */
  ...
  /**
   * @generated from field: moneydashboard.v4.AccountGroup account_group = 9;
   */
