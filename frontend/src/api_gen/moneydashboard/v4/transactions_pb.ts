...
export const file_moneydashboard_v4_transactions: GenFile = /*@__PURE__*/
  fileDesc("", [file_moneydashboard_v4_categories, file_moneydashboard_v4_holdings, file_moneydashboard_v4_users]);
...
export type Transaction = Message<"moneydashboard.v4.Transaction"> & {
  ...
  /**
   * @generated from field: moneydashboard.v4.Profile profile = 12;
   */
  profile?: Profile;
};
...
export type GetTransactionPageResponse = Message<"moneydashboard.v4.GetTransactionPageResponse"> & {
  ...
  /**
   * @generated from field: int32 filteredTotal = 2;
   */
  filteredTotal: number;

  /**
   * @generated from field: repeated moneydashboard.v4.Transaction filteredEntities = 3;
   */
